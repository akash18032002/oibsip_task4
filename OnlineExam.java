...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Que1: Which statement is true about Java?");  
            jb[0].setText(" Java is a sequence-dependent programming language");jb[1].setText("Java is a platform-independent programming language");jb[2].setText("Java is a code dependent programming language");jb[3].setText("Java is a platform-dependent programming language");   
        }  
        if(current==1)  
        {  
        ...
        {  
            ...
            jb[0].setText("Use of pointers");jb[1].setText("Object-oriented");jb[2].setText("Portable");jb[3].setText("Dynamic and Extensible");  
        }  
        if(current==3)  
        {  
            l.setText("Que4: Which of these cannot be used for a variable name in Java?");  
            jb[0].setText("keyword");jb[1].setText("identifier & keyword");jb[2].setText("identifier");jb[3].setText("none of the mentioned");  
        }  
        if(current==4)  
        {  
        ...
        {  
            ...
            jb[0].setText(".java");jb[1].setText(".js");jb[2].setText(".txt");  
                        jb[3].setText(".class");  
        }  
        if(current==7)  
        {  
            l.setText("Que8: Which environment variable is used to set the java path?");  
            jb[0].setText("JAVA");jb[1].setText("JAVA_HOME");jb[2].setText("JavaPATH");  
                        jb[3].setText("MAVEN_Path");         
        }  
        if(current==8)  
        {  
        ...
        if(current==9)  
        {  
            l.setText("Que10: Which of the following is a superclass of every class in Java?");  
            jb[0].setText("ArrayList");jb[1].setText("Abstract clas");jb[2].setText("Object class");  
                        jb[3].setText("String");  
        }  
        l.setBounds(30,40,450,20);  
